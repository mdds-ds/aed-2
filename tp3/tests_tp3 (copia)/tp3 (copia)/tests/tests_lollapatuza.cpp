...
/** NUESTRO TEST -------------------------------------------------------
La idea de este test es hackear a todas las personas con todas sus compras (todas las compras son sin descuento),
pensamos que esto puede ser un buen caso para romper nuestro algoritmo porque verifica la correcta implementacion de
varias funciones en casos limite.
**/
TEST_F(LollaTest, hackeamosTodo){
    menu = {{3, 500}, {4, 1000}, {5, 2500}, {7, 2000}};
    personas = {2, 4, 8};
    idsPuestos = {2, 6, 7};
    stock2 = {{3, 10}, {4, 5}, {5, 30}, {7, 10}};
    stock6 = {{3, 5}, {4, 15}, {5, 25}, {7, 5}};
    stock7 = {{3, 20}, {4, 20}, {5, 20}, {7, 20}};
    descuentos2 = {{7, {{100, 2}, {100, 2}}}};
    descuentos6 = {{4, {{100, 1}}}};
    descuentos7 = {{3, {{100, 30}}}, {7, {{100, 1}}}};
    puesto2 = {stock2, descuentos2, menu};
    puesto6 = {stock6, descuentos6, menu};
    puesto7 = {stock7, descuentos7, menu};
    puestos = {{2, puesto2}, {6, puesto6}, {7, puesto7}};
    ...
    /** EMPEZAMOS CORRIENDO TEST GENERICOS PARA ASEGURARNOS QUE NUESTRO CONJUNTO DE DATOS NO GENERA NINGUN PROBLEMA
     **/
    for (const Persona& p : personas) {
        EXPECT_EQ(l.gastoTotal(p), 0);
    }
    ...
    /** REGISTRAMOS TODAS LAS COMPRAS SIN DESCUENTO DE LAS PERSONAS **/
    l.registrarCompra(2, 3, 2, 2);
    l.registrarCompra(8, 5, 2, 7);
    l.registrarCompra(4, 7, 1, 6);
    l.registrarCompra(4, 4, 1, 2);
    l.registrarCompra(4, 3, 4, 7);

    /**CHEQUEAMOS QUE EL GASTO TOTAL CORRESPONDA CON LAS COMPRAS**/
    EXPECT_EQ(l.mayorGastador(), 4);
    EXPECT_EQ(l.gastoTotal(2),1000);
    EXPECT_EQ(l.gastoTotal(8),5000);
    ...
    l.hackear(4,3);
    l.hackear(4,3);
/**CHEQUEMOS QUE SE ACTUALICE CORRECTAMENTE EL MAYOR GASTADOR**/
    EXPECT_EQ(l.mayorGastador(),8);
    ...
    /**CHEQUEAMOS QUE TODOS LOS GASTOS TOTALES DE LAS PERSONAS ESTEN EN 0**/
    EXPECT_EQ(l.gastoTotal(2),0);
    EXPECT_EQ(l.gastoTotal(8),0);
    EXPECT_EQ(l.gastoTotal(4),0);


    /**CHEQUEAMOS QUE EL MAYOR GASTADOR SEA EL DE MENOR ID**/
    EXPECT_EQ(l.mayorGastador(),2);



    /**CHEQUEAMOS QUE EL STOCK SEA IGUAL AL INICIAL**/
    EXPECT_EQ(l.stockEnPuesto(7,5),20);
    EXPECT_EQ(l.stockEnPuesto(7,3),20);
    EXPECT_EQ(l.stockEnPuesto(6,7),5);
    EXPECT_EQ(l.stockEnPuesto(2,3),10);
...
/**NUESTRO TEST -------------------------------------------------------
 La idea de este test es ver que devolvemos correctamente al mayorGastador en caso de empate (el de menor ID)
 **/
TEST_F(LollaTest, mayorGastadorTieneMenorID){
    menu = {{3, 500}, {4, 1000}, {5, 2500}, {7, 2000}};
    personas = {2, 4, 8};
    idsPuestos = {2, 6, 7};
    stock2 = {{3, 10}, {4, 5}, {5, 30}, {7, 10}};
    ...
    /**CHEQUEAMOS QUE EL MAYOR GASTADOR SEA EL DE MAYOR GASTO PERO DE MENOR ID**/
    EXPECT_EQ(l.mayorGastador(), 4);
